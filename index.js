...
client.connect(err => {
    ...
    const reviewCollection = client.db("travGeek").collection("review");
    const serviceCollection = client.db("travGeek").collection("services");
    const orderCollection = client.db("travGeek").collection("orders");
    const adminCollection = client.db("travGeek").collection("admin");
